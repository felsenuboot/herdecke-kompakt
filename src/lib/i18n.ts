...
const en: Dict = {
  ...
  'Standort bestimmen für deine nächste Abfuhr:': 'Detect your location for your next collection:',
  'Standortbestimmung wird von deinem Browser nicht unterstützt.': 'Your browser does not support location detection.',
  'Adresse konnte nicht bestimmt werden.': 'Could not determine your address.',
  'Standortzugriff wurde abgelehnt.': 'Location access was denied.',
...
const uk: Dict = {
  ...
  'Adresse manuell eingeben →': 'Ввести адресу вручну →',
  'Standort bestimmen für deine nächste Abfuhr:': 'Визначте місцезнаходження для найближчого вивозу:',
  'Standortbestimmung wird von deinem Browser nicht unterstützt.': 'Ваш браузер не підтримує визначення місцезнаходження.',
  'Adresse konnte nicht bestimmt werden.': 'Не вдалося визначити адресу.',
  'Standortzugriff wurde abgelehnt.': 'Доступ до місцезнаходження відхилено.',
